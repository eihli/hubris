...
use drv_sidecar_mainboard_controller::tofino2::{
    DebugPortState, DirectBarSegment, SpiEepromInstruction, Tofino2Vid,
...
impl idl::InOrderSequencerImpl for ServerImpl {
    ...
    fn send_spi_eeprom_instruction(
        &mut self,
        _: &RecvMessage,
    ...
    fn read_spi_eeprom(
        ...
        _: &RecvMessage,
        offset: u32,
    ) -> Result<[u8; 4], RequestError<SeqError>> {
        Ok(self
            .tofino
            .debug_port
            .read_spi_eeprom(offset.try_into().unwrap())
            .map_err(SeqError::from)?)
    }
    ...
    fn write_spi_eeprom(
        ...
        Ok(self
            .tofino
            .debug_port
            .write_spi_eeprom(offset.try_into().unwrap(), data.to_le_bytes())
            .map_err(SeqError::from)?)
    }
...
mod idl {
    use super::{
        DebugPortState, DirectBarSegment, SeqError, SpiEepromInstruction,
        TofinoPcieReset, TofinoSeqError, TofinoSeqState, TofinoSequencerPolicy,
    };
